...
class BaseActorDistribution(nn.Module):
    """
    BaseActorDistribution interface. 
    """
...
class DeterministicActorDistribution(BaseActorDistribution):
    """
...
class SquashedDeterministicActorDistribution(DeterministicActorDistribution):
    """
...
class ClippedDeterministicActorDistribution(DeterministicActorDistribution):
    """
...
class GaussianActorDistribution(BaseActorDistribution):
    """
...
class SquashedGaussianActorDistribution(GaussianActorDistribution):
    """
    ...
    ***(any args of MLP or EnsembleMLP)
    ...
    def __init__(
        ...
        *, 
        ...
        super().__init__(
            input_dim, output_dim, reparameterize, conditioned_logstd, fix_logstd, logstd_min, logstd_max, device,  
            ensemble_size=ensemble_size, 
            hidden_dims=hidden_dims, 
            norm_layer=norm_layer, 
            activation=activation, 
...
class ClippedGaussianActorDistribution(GaussianActorDistribution):
    """
...
class CategoricalActorDistribution(BaseActorDistribution):
    """
