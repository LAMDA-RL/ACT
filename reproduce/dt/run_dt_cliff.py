...
from acsl.utils.eval import eval_decision_transformer, dump_dt_actions
...
obss, actions = dump_dt_actions(env, policy, args.target_returns[0], args.return_scale, 10, args.seed)
for i in range(10):
